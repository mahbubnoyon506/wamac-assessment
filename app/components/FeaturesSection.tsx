...
import { Lightbulb, BrainIcon } from "lucide-react";
  ...
  return (
    <section className="bg-background py-12 md:py-24 px-6 relative overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        {/* Section Header */}
        <Badge label="The Deep Work Blueprint" className="mb-3" />
        ...
        <div className="relative flex flex-col gap-12">
          ...
          {features.map((feature, index) => (
            <div key={index} className="relative flex items-start gap-10">
              {/* Timeline dot — aligned to the top of the row */}
              <div className="relative z-10 mt-1 w-4 h-4 shrink-0 rounded-full bg-primary-500 border-2 border-primary-500 shadow-[0_0_10px_rgba(36,102,242,0.5)]" />

              {/* Icon + Text stacked vertically, to the right of the dot */}
